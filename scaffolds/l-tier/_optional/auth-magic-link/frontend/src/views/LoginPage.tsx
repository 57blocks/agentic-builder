 ...
 *
 * In dev mode (no SMTP_HOST), the backend logs the link to the structured
 * logger — look for the `text` field in the pino output.
 */
      ...
      <div className="min-h-screen flex items-center justify-center bg-slate-950 px-4">
        <div className="w-full max-w-md rounded-2xl border border-slate-800 bg-slate-900/80 backdrop-blur p-7 shadow-xl">
          ...
          <p className="mt-3 text-[12px] text-slate-500">
            ...
            backend log (look for the <code>text</code> field in pino output).
          </p>
          <button
            type="button"
            onClick={() => {
