...
function StyleSpecCard({ record, onOpen }: { record: KnowledgeRecordFull; onOpen: () => void }) {
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.98 }}
      onClick={onOpen}
      className={`group relative rounded-[4px] overflow-hidden border bg-white text-left shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] transition-shadow hover:shadow-md ${
